...
public class App {
	...
	public static void main(String[] args) {
		...
		long[][] arraysLength10 = new long[5][];
		...
		for (int i = 0; i < arraysLength10.length; i++) {
			arraysLength10[i] = GeradorDeSequencias.geradorCinco(10);
		...
		facadeOrdenadores.setAlgoritmo(new BubbleSort());
